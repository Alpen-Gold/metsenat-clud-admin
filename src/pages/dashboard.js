...
import RechardExample from "../components/charts/lineChart";
    ...
    <>
      ...
      <Container>
        <div className="flex justify-between my-7">
          <div className="w-[381px] min-h-[96px]   bg-white   rounded-[8px] flex p-4 justify-start items-center gap-3">
            <svg
            ...
            <div>
              <p className="p-0 m-0">Jami to‘langan summa</p>
              <h4 className="p-0 m-0">
                {studentsData.reduce(
                  (total, value) => total + value.sponsorSum,
                  0
                )}
                UZS
              </h4>
          ...
          <div className="w-[381px] min-h-[96px]   bg-white   rounded-[8px] border-[1px solid grey] flex p-4 justify-start items-center gap-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="48"
              height="48"
            ...
            <div>
              <p className="p-0 m-0">Jami so‘ralgan summa</p>
              <h4 className="p-0 m-0">
                {studentsData.reduce(
                  (total, value) => total + value.kontraktSum,
                  0
                )}
                UZS
              </h4>
          ...
          <div className="w-[381px] min-h-[96px]   bg-white   rounded-[8px] border-[1px solid grey] flex p-4 justify-start items-center gap-3">
            ...
            <div>
              <p className="p-0 m-0">To‘lanishi kerak summa</p>
              <h4 className="p-0 m-0">
                {studentsData.reduce(
                  (total, value) => total + value.kontraktSum,
                  0
